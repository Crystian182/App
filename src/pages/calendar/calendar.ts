...
export class CalendarPage {
 ...
 selectedDay: Day = this.days[0]
  ...
  public schedulerProvider: SchedulerProvider, private launchNavigator: LaunchNavigator) {
      ...
      this.events.push({title: 'Analisi', startDate: start, endDate: end})
      this.events.push({title: 'Analisi', startDate: start, endDate: end})
      this.events.push({title: 'Analisi', startDate: start, endDate: end})
      this.events.push({title: 'Geometria', startDate: start, endDate: end})
      this.events.push({title: 'ciao4', startDate: start, endDate: end})
  }
